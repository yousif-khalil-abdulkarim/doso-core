...
```ts file=./samples/memory-semaphore-adapter.ts

```

You can also provide an `Map` that will be used for storing the data in memory:

```ts file=./samples/memory-semaphore-adapter-with-map.ts
...
```ts file=./samples/memory-semaphore-remove-all-expired.ts
...
```ts file=./samples/memory-semaphore-adapter-deinit.ts
...
```ts file=./samples/mongodb-semaphore-adapter.ts

```

You can change the collection name:

```ts file=./samples/mongodb-semaphore-collection-name.ts

```

You can change the collection settings:

```ts file=./samples/mongodb-semaphore-collection-settings.ts
...
```ts file=./samples/mongodb-semaphore-adapter-deinit.ts
...
```ts file=./samples/redis-semaphore-adapter.ts
...
```ts file=./samples/kysely-semaphore-sqlite.ts
...
```ts file=./samples/kysely-semaphore-postgres.ts
...
```ts file=./samples/kysely-semaphore-mysql.ts
...
```ts file=./samples/kysely-semaphore-libsql.ts
...
```ts file=./samples/kysely-semaphore-remove-all-expired.ts
...
```ts file=./samples/kysely-semaphore-adapter-deinit.ts
...
```ts file=./samples/no-op-semaphore-adapter.ts
