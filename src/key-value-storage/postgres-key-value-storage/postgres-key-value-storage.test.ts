...
describe("class: PostgresKeyValueStorageInternal", () => {
    ...
    describe.only("method: insertIfNotExistsMany", () => {
        ...
        test("Should clamp inserted number value when given a min value and when value over max for a given namespace", async () => {
            await db
                .insertInto(SQL_KV_STORAGE_TABLE_NAME)
                .values([
                    {
        ...
        test("Should clamp inserted number value when given a max value and when value under min for a given namespace", async () => {
            await db
                .insertInto(SQL_KV_STORAGE_TABLE_NAME)
                .values([
                    {
        ...
        test("Should not throw error when given number value with clamp", async () => {
            await db
                .insertInto(SQL_KV_STORAGE_TABLE_NAME)
                .values([
                    {
    ...
    describe("method: updateIfExistsMany", () => {
        ...
        test("Should clamp updated number value when given a min value and when value over max for a given namespace", async () => {
            await db
                .insertInto(SQL_KV_STORAGE_TABLE_NAME)
                .values([
                    {
    ...
    describe("method: insertOrUpdateMany", () => {
        ...
        test("Should clamp inserted or updated number value when given a min value and when value over max for a given namespace", async () => {
            await db
                .insertInto(SQL_KV_STORAGE_TABLE_NAME)
                .values([
                    {
        ...
        test("Should clamp inserted or updated number value when given a max value and when value under min for a given namespace", async () => {
            await db
                .insertInto(SQL_KV_STORAGE_TABLE_NAME)
                .values([
                    {
